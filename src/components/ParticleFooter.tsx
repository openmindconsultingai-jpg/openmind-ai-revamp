  ...
  return (
    <footer ref={sectionRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center flex flex-col items-center justify-center">
        ...
        {/* Social Media Links */}
        <div className="flex items-center justify-center gap-6 md:gap-8 mb-16">
          {/* LinkedIn */}
          <a
            href="https://linkedin.com/company/openmind-ai"
            target="_blank"
            rel="noopener noreferrer"
            className="group p-4 md:p-5 rounded-full glass border border-primary/30 hover:border-primary transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_hsl(176_100%_43%/0.4)]"
          >
            <svg className="w-8 h-8 md:w-10 md:h-10 text-foreground group-hover:text-primary transition-colors" fill="currentColor" viewBox="0 0 24 24">
