...
const translations: Translations = {
  pl: {
    ...
    'hero.cta.consultation': 'Napisz do nas przez formularz',
...
W tej rzeczywistości rola twórcy ulegnie głębokiej redefinicji. Twórca przyszłości to nie rzemieślnik dłubiący w pikselach, ale reżyser i kurator, zarządzający orkiestrą inteligentnych algorytmów. Umiejętność techniczna ustąpi miejsca wyobraźni, smakowi artystycznemu i zdolności łączenia kropek ("Model Orchestration"), gdzie jedynym limitem staje się kreatywność w zadawaniu pytań i definiowaniu wizji.`,
    ...
    'services.cta': 'Napisz do nas przez formularz',
    ...
    'seo.section1.title': 'Konsulting i wdrożenia AI w Polsce',
    'seo.section1.content': 'Nie wiesz jak zacząć ze sztuczną inteligencją? OpenMind AI przeprowadzi Cię przez cały proces – od audytu potrzeb, przez dobór narzędzi AI, aż po pełne wdrożenie i szkolenie zespołu. Pomagamy firmom każdej wielkości wejść w świat sztucznej inteligencji bez zbędnego ryzyka.',
    'seo.section2.title': 'Szkolenia ze Sztucznej Inteligencji',
    'seo.section2.content': 'Nasze szkolenia AI to praktyczna wiedza bez zbędnej teorii. Uczymy jak używać ChatGPT, automatyzować procesy, tworzyć obrazy i wideo przy pomocy sztucznej inteligencji. Szkolenia dostępne online i stacjonarnie w całej Polsce – dla firm, agencji i szkół.',
    'seo.section3.title': 'Automatyzacja Procesów ze Sztuczną Inteligencją',
    'seo.section3.content': 'Sztuczna inteligencja może przejąć powtarzalne zadania w Twojej firmie – obsługę klienta, generowanie raportów, analizę danych i więcej. OpenMind AI projektuje i wdraża automatyzacje oparte na AI, które realnie oszczędzają czas i pieniądze.',
    'seo.section4.title': 'Agencja Kreatywna AI – Wideo i Obrazy generowane przez AI',
    'seo.section4.content': 'Tworzymy profesjonalne materiały reklamowe z wykorzystaniem sztucznej inteligencji: wideo AI, obrazy AI, animacje i content dla mediów społecznościowych. Generatywna AI otwiera nowe możliwości dla Twojej marki – szybciej i taniej niż tradycyjne metody.',
    'seo.section5.title': 'Sztuczna Inteligencja dla Szkół i Edukacji',
    'seo.section5.content': 'OpenMind AI wspiera szkoły i nauczycieli w Polsce we wdrożeniu AI do edukacji. Prowadzimy warsztaty dla uczniów, szkolenia dla nauczycieli i pomagamy placówkom zrozumieć i bezpiecznie wykorzystać sztuczną inteligencję w nauczaniu.',
    'seo.faq.title': 'Najczęstsze pytania o Sztuczną Inteligencję',
    'seo.faq1.question': 'Czym jest AI i jak działa?',
    'seo.faq1.answer': 'AI (Artificial Intelligence), czyli sztuczna inteligencja, to technologia umożliwiająca maszynom uczenie się, rozumienie języka naturalnego i podejmowanie decyzji. OpenMind AI pomaga firmom i szkołom w całej Polsce wdrażać rozwiązania oparte na sztucznej inteligencji.',
    'seo.faq2.question': 'Jak sztuczna inteligencja może pomóc mojej firmie?',
    'seo.faq2.answer': 'AI automatyzuje powtarzalne zadania, analizuje dane, obsługuje klientów przez chatboty, generuje treści marketingowe i wspiera podejmowanie decyzji. OpenMind AI pomoże zidentyfikować obszary, w których sztuczna inteligencja przyniesie Twojej firmie największe korzyści.',
    ...
    'seo.faq4.question': 'Ile kosztuje wdrożenie AI?',
    'seo.faq4.answer': 'Koszt zależy od zakresu projektu. Oferujemy bezpłatną konsultację, podczas której oceniamy potrzeby i przedstawiamy wycenę. Nasze rozwiązania AI są skalowalne – możesz zacząć od małego projektu pilotażowego i rozwijać go w miarę potrzeb.',
    'seo.faq5.question': 'Czy AI zastąpi moich pracowników?',
    'seo.faq5.answer': 'Sztuczna inteligencja nie zastępuje ludzi – wspiera ich. AI przejmuje powtarzalne, czasochłonne zadania, dzięki czemu pracownicy mogą skupić się na kreatywnej i strategicznej pracy. Nasze wdrożenia zawsze uwzględniają szkolenie zespołu.',
